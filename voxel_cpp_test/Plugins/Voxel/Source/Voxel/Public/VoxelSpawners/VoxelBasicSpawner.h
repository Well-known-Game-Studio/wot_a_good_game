...
class VOXEL_API FVoxelBasicSpawnerProxy : public FVoxelSpawnerProxy
{
public:
	...
	const FVoxelBasicSpawnerScaleSettings Scaling;
	const EVoxelBasicSpawnerRotation RotationAlignment;
	...
	FVoxelBasicSpawnerProxy(UVoxelBasicSpawner* Spawner, FVoxelSpawnerManager& Manager, EVoxelSpawnerProxyType Type, uint32 Seed);
