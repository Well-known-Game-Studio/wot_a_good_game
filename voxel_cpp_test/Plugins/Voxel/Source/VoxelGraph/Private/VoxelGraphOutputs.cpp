...
FString FVoxelGraphOutput::GetDeclaration(FVoxelCppConstructor& Constructor) const
{
	return Constructor.GetTypeString(Category) + " " + Name.ToString();
}

FString FVoxelGraphOutput::GetRefDeclaration(FVoxelCppConstructor& Constructor) const
{
	return Constructor.GetTypeString(Category) + "& " + Name.ToString();
}
