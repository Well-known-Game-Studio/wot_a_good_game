...
TVoxelSharedPtr<FVoxelComputeNode> UVoxelNode::GetComputeNode(const FVoxelCompilationNode& InCompilationNode) const
{
	check(false);
	return TVoxelSharedPtr<FVoxelComputeNode>();
}


TSharedPtr<FVoxelCompilationNode> UVoxelNode::GetCompilationNode() const
{
	return MakeShared<FVoxelDefaultCompilationNode>(*this);
}
