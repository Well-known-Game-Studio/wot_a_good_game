...
TSharedPtr<FVoxelCompilationNode> UVoxelLocalVariableDeclaration::GetCompilationNode() const
{
	return MakeShared<FVoxelLocalVariableDeclarationCompilationNode>(*this);
}
...
TSharedPtr<FVoxelCompilationNode> UVoxelLocalVariableUsage::GetCompilationNode() const
{
	return MakeShared<FVoxelLocalVariableUsageCompilationNode>(*this);
}
