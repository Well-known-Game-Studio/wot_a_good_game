...
TSharedPtr<FVoxelCompilationNode> UVoxelNode_BiomeMerge::GetCompilationNode() const
{
	auto* BiomeMerge = new FVoxelBiomeMergeCompilationNode(*this);
	BiomeMerge->Tolerance = Tolerance;
	return MakeShareable(BiomeMerge);
}
