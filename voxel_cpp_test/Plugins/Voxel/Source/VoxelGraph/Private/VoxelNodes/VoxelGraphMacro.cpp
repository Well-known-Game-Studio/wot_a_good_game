...
TSharedPtr<FVoxelCompilationNode> UVoxelGraphMacroInputOutputNode::GetCompilationNode() const
{
	return MakeShared<FVoxelMacroInputOuputCompilationNode>(*this);
}
...
TSharedPtr<FVoxelCompilationNode> UVoxelGraphMacroNode::GetCompilationNode() const
{
	return MakeShared<FVoxelMacroCompilationNode>(*this);
}
