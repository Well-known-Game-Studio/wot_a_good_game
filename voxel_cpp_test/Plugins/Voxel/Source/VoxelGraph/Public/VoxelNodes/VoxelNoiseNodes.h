...
protected:
	const EVoxelCellularDistanceFunction DistanceFunction;
	const EVoxelCellularReturnType ReturnType;
	const float Jitter;
};
...
class FVoxelCraterNoiseComputeNode : public FVoxelNoiseComputeNode
{
public:
	FVoxelCraterNoiseComputeNode(const UVoxelNode_CraterNoise& Node, const FVoxelCompilationNode& CompilationNode);
...
class FVoxelCraterNoiseFractalComputeNode : public FVoxelNoiseFractalComputeNode
{
public:
	FVoxelCraterNoiseFractalComputeNode(const UVoxelNode_CraterNoiseFractal& Node, const FVoxelCompilationNode& CompilationNode);
