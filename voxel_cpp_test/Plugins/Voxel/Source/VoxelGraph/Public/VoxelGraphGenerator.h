...
public:
	...
	bool CompileToCpp(FString& OutHeader, FString& OutCpp, const FString& Filename);
	// Create the compiled graphs of this graph
	bool CreateGraphs(
		FVoxelCompiledGraphs& OutGraphs,
		bool bPreview,
		bool bAutomaticPreview,
		bool bOnlyShowAxisDependencies);
	// Get the generator instance of this graph, optionally enabling preview
	bool GetGraphInstance(
